...
- 最終更新: 2026-07-14（**縮退シーム解消セッション**: 「動くが機能しない」後退 5 機能を実装完了 + 敵対的レビューの確定 2 件を修正。全ゲート緑 — build ✅ / clippy -D ✅ / **test 402** ✅ / deny exit0 ✅）
...
| `cargo test --workspace` | ✅ **402 passed / 0 failed**（2026-07-14 の縮退シーム解消 5 機能 + 敵対的レビュー修正で +16） |
...
| HTTP ルート被覆 | 59 / 152 パス ≒ **39%**（認証 7 + `/api/me` + 9 ドメイン CRUD。2026-07-14 に timeline media 2 ルートを追加） |
