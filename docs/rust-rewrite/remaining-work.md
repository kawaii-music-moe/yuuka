...
- [ ] **P0-1 未コミットの V17 マイグレーション修正をコミットし、以後 V17 を凍結する**
...
- [ ] **P0-2 cron の所有を片側専任にする（二重 writer ハザード回避）**
...
- [ ] **P0-3 nginx strangler のポート整合とルーティング明示**
...
- [ ] **P1-5 秘密情報の暗号層（Argon2id + AES-256-GCM）を実装する**
...
- [ ] **P1-6 未コミットの Batch 4/5/6 修正を確定コミットする**
