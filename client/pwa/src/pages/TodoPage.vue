...
const todos = ref<Todo[]>([]); const title = ref(''); const dueDate = ref(''); const list = ref('個人'); const loading = ref(true); const error = ref(''); const showDone = ref(false); const actionError = ref('')
